...
int main() {
	pic10b::VectorString vs; //build default object
	...
	pic10b::VectorString vs2(std::move(foo_out)); //rvalue reference (call move constructor)
	...
	pic10b::VectorString vs3(4, "beta"); //call copy constructor
	vs3.pop_back();
	vs3.push_back("delta");
	...
	const auto vs4 = std::move(vs); //call move assignment??
